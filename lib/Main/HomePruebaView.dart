...
class HomePruebaView extends StatefulWidget {


  @override
  State<HomePruebaView> createState() => _HomeViewState();
}

class _HomeViewState extends State<HomePruebaView>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Text("Entra en el drawer, lo importante esta en el movil que es donde puedes postear imagenes"),
      ),
      drawer:Image.network("https://media.tenor.com/zBc1XhcbTSoAAAAC/nyan-cat-rainbow.gif",width: 80, height:80),
